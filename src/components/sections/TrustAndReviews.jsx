...
import video from "../../../public/packaging.mp4"
...
export default function TrustAndReviews() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user) {
      return alert("মতামত জানাতে অনুগ্রহ করে লগিন করুন!");
    }
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("আপনি কি নিশ্চিত যে আপনি আপনার মতামত মুছে ফেলতে চান?")) {
      return;
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="font-heading text-4xl md:text-5xl text-sindoor-red leading-tight">
              নিরাপদ ও প্রিমিয়াম <br />
              প্যাকেজিং
            </h2>

            <p className="font-bengali text-lg text-gray-600 leading-relaxed max-w-md">
              আমরা জানি পূজার সামগ্রীর পবিত্রতা কতটা গুরুত্বপূর্ণ। তাই প্রতিটি
              বক্স অত্যন্ত পরম যত্নে প্যাক করা হয় যাতে আপনার হাতে নিরাপদে
              পৌঁছায়।
            </p>
            ...
            <motion.div
              ...
              className="mt-4 relative aspect-video bg-black rounded-3xl border-2 border-golden-orange/20 overflow-hidden shadow-[0_10px_40px_rgba(255,140,0,0.1)]"
            >
              <video
              ...
              >
                ...
                আপনার ব্রাউজার ভিডিওটি চালাতে পারে না।
              </video>
            </motion.div>
          </motion.div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <h2 className="font-heading text-4xl text-golden-orange mb-4 text-center lg:text-left">
              গ্রাহকের বিশ্বাস
            </h2>
            ...
            <div className="flex flex-col gap-6 max-h-[500px] overflow-y-auto pr-2 hide-scrollbar">
              ...
              {comments.length > 0 ? (
                comments.slice(0, 10).map((review, i) => (
                  <motion.div
                    key={review._id}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mt-auto">
                      ...
                      <div>
                        <h4 className="font-bengali font-bold text-gray-900">
                          {review.name}
                        </h4>
                ...
                <p className="text-gray-500 text-center italic font-bengali py-10">
                  এখনো কোনো মতামত নেই।
                </p>
              )}
            ...
            {user ? (
              <div className="mt-4 bg-white/80 backdrop-blur-md p-6 rounded-2xl border border-soft-gold/30 shadow-sm shrink-0">
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bengali text-gray-600">
                      রেটিং:
                    </span>
                    ...
                    {[1, 2, 3, 4, 5].map((num) => (
                      <Star
                        key={num}
                        size={20}
                        className={`cursor-pointer transition-colors ${rating >= num
                          ? "text-golden-orange"
                          : "text-gray-300"
                          }`}
                        fill={
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="flex-1 px-6 py-2 bg-gradient-to-r from-sindoor-red to-golden-orange hover:shadow-lg text-white font-bengali font-bold tracking-wide rounded-xl transition"
                    >
                      {editingId
                        ? "আপডেট করুন"
                        : "পোস্ট করুন"}
                    ...
                    {editingId && (
                      <button
                        ...
                        className="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bengali font-bold rounded-xl transition"
                      >
                        বাতিল
                      </button>
                    )}
              ...
              <div className="mt-4 text-center bg-white/50 p-6 rounded-2xl border border-gray-100 shrink-0">
                ...
                <p className="font-bengali text-gray-600">
                  ...
                  <Link
                    to="/login"
                    className="text-sindoor-red font-bold hover:underline"
                  >
                    লগিন
                  </Link>{" "}
                  করুন
